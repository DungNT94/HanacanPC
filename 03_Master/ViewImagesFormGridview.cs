...
{
    public partial class ViewImagesFormGridview : DevExpress.XtraEditors.XtraForm
    {
        public ViewImagesFormGridview()
        {
            InitializeComponent();
        ...
        private void ViewImagesFormGridview_Load(object sender, EventArgs e)
        {
            ReviewImage();
        }
    }
